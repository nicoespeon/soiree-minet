...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    // This task compiles the LESS files into CSS
    less: {
      development: {
        options: {
          compress: true
      ...
      debug: {
        ...
        files: {
          "dist/debug/css/index.css": "app/styles/less/index.less"
        }
      },
      release: {
        options: {
        ...
        files: {
          "dist/release/css/index.css": "app/styles/less/index.less"
        }
      }
    },
